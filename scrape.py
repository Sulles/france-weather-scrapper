...
parser = argparse.ArgumentParser(
    ...
    description=
    "Scrape historic weather data from https://www.infoclimat.fr/observations-meteo/archives")
parser.add_argument(
    "-s", "--start", required=True, dest="start", metavar="start_date", type=dd_mm_yyyy2date,
    help="start date as dd_mm_yyyy")
parser.add_argument(
    "-e", "--end", default=datetime.datetime.now().date(), dest="end", metavar="end_date",
    type=dd_mm_yyyy2date, help="end date as dd_mm_yyyy")
parser.add_argument(
